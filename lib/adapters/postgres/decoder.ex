...
defmodule Hadrian.Adapters.Postgres.Decoder do
  ...
  alias Hadrian.Adapters.Postgres.OidDatabase
  require Logger
  ...
  ## Examples
      ...
      %Hadrian.Adapters.Postgres.Decoder.Messages.Insert{relation_id: 24576, tuple_data: {"baz", "560"}}
